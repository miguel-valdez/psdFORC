...
\section{Results}
For ensembles with SD particles $<50\nm$, hysteresis behaviour is dominated by coherent rotation (Fig. \ref{FIG_02}). This is seen by comparing FORC diagrams for these ensembles (Fig. \ref{FIG_02}b) with those of idealised SD (effectively a single magnetic dipole), coherently rotating greigite particles (Fig. \ref{FIG_02}a) determined using the method outlined in \citet{ValdezGrijalva2017}. Diagrams for particles $<50\nm$ obtained with the micromagnetic algorithm (Fig. \ref{FIG_02}b) are offset $\roughly 3\mT$ to the left compared to the dipole model (Fig. \ref{FIG_02}a); lower coercivities due to the micromagnetic algorithm, which includes flowering (small deviations from a perfect SD structure) as a result of magnetostatic self-interaction effects, account for this effect.\par
...
This research was partially funded by Instituto Mexicano del Petr\'oleo scholarship PCTRES (M. A. Valdez-Grijalva), UK Natural Environment Research Council grant NE/J020508/1 (A. R. Muxworthy and W. Williams), and Australian Research Council grant DP160100805 (A. P. Roberts and A. R. Muxworthy).\par
%-----------------------------------------------------
...
%\begin{figure}[ht]
%\centering
%\includegraphics[width=\textwidth]{FIG_05BW.pdf}
